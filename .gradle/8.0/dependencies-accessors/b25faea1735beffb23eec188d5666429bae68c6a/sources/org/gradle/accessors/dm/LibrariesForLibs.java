...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getGenerativeai() { return create("generativeai"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: generativeai (0.2.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class GooglePluginAccessors extends PluginFactory {
         ...
         */
        public GoogleAndroidPluginAccessors getAndroid() { return paccForGoogleAndroidPluginAccessors; }
    ...
    public static class GoogleAndroidPluginAccessors extends PluginFactory {
         ...
         */
        public GoogleAndroidLibrariesPluginAccessors getLibraries() { return paccForGoogleAndroidLibrariesPluginAccessors; }
    ...
    public static class GoogleAndroidLibrariesPluginAccessors extends PluginFactory {
         ...
         */
        public GoogleAndroidLibrariesMapsplatformPluginAccessors getMapsplatform() { return paccForGoogleAndroidLibrariesMapsplatformPluginAccessors; }
    ...
    public static class GoogleAndroidLibrariesMapsplatformPluginAccessors extends PluginFactory {
         ...
         */
        public GoogleAndroidLibrariesMapsplatformSecretsPluginAccessors getSecrets() { return paccForGoogleAndroidLibrariesMapsplatformSecretsPluginAccessors; }
    ...
    public static class GoogleAndroidLibrariesMapsplatformSecretsPluginAccessors extends PluginFactory {
         ...
         */
        public GoogleAndroidLibrariesMapsplatformSecretsGradlePluginAccessors getGradle() { return paccForGoogleAndroidLibrariesMapsplatformSecretsGradlePluginAccessors; }
